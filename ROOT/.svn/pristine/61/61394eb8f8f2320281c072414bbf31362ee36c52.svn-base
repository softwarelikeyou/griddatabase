...
import com.griddatabase.settlementpoints.KMLOpenGISNamespaceContext;
import com.softwarelikeyou.facade.SettlementPointFacade;
import com.softwarelikeyou.model.entity.SettlementPoint;

public class SettlementPointJob implements StatefulJob {

	public static Logger logger = Logger.getLogger(SettlementPointJob.class);
		...
		try {
            ...
            for (int i = 0; i < places.getLength(); i++) {
                ...
                if (settlementPoint == null) {
    				...
    				Jobs.sechduleStation(settlementPoint, Initialization.settlementPointScheduler);
