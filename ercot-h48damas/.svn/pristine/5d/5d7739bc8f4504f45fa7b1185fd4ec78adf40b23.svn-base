...
public abstract class Saver {
	...
	public abstract boolean saveAG(List<Map<String, String>> list) throws H48DAMASException;
	
	public abstract boolean saveCS(List<Map<String, String>> list) throws H48DAMASException;
