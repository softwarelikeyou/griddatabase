...
@Entity
@Table(name="h48damasagonns")
@org.hibernate.annotations.Table(appliesTo="h48damasagonns", 
		indexes=@org.hibernate.annotations.Index(name="intervalDateIdx", columnNames={"intervalDate"}))
@XmlRootElement(name="H48DAMASAGONNS")
@Path("/H48DAMASAGONNS")
@XmlAccessorType(XmlAccessType.FIELD)
public class H48DAMASAGONNS implements Serializable {
	...
	public List<H48DAMASAGONNS> findByDate(@QueryParam("date") String date) {
		if (date == null)
		...
		final List<H48DAMASAGONNS> list = null;
		try {
