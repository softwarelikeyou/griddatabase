...
@Entity
@Table(name="h48damasagoffns")
@org.hibernate.annotations.Table(appliesTo="h48damasagoffns", 
		indexes=@org.hibernate.annotations.Index(name="intervalDateIdx", columnNames={"intervalDate"}))
@XmlRootElement(name="H48DAMASAGOFFNS")
@Path("/H48DAMASAGOFFNS")
@XmlAccessorType(XmlAccessType.FIELD)
public class H48DAMASAGOFFNS implements Serializable {
	...
	public List<H48DAMASAGOFFNS> findByDate(@QueryParam("date") String date) {
		if (date == null)
		...
		final List<H48DAMASAGOFFNS> list = null;
		try {
