...
@Entity
@Table(name="h48damasagregdn")
@org.hibernate.annotations.Table(appliesTo="h48damasagregdn", 
		indexes=@org.hibernate.annotations.Index(name="intervalDateIdx", columnNames={"intervalDate"}))
@XmlRootElement(name="H48DAMASAGREGDN")
@Path("/H48DAMASAGREGDN")
@XmlAccessorType(XmlAccessType.FIELD)
public class H48DAMASAGREGDN implements Serializable {
	...
	public List<H48DAMASAGREGDN> findByDate(@QueryParam("date") String date) {
		if (date == null)
		...
		final List<H48DAMASAGREGDN> list = null;
		try {
