...
@Entity
@Table(name="h48damasagrrsgn")
@org.hibernate.annotations.Table(appliesTo="h48damasagrrsgn", 
		indexes=@org.hibernate.annotations.Index(name="intervalDateIdx", columnNames={"intervalDate"}))
@XmlRootElement(name="H48DAMASAGRRSGN")
@Path("/H48DAMASAGRRSGN")
@XmlAccessorType(XmlAccessType.FIELD)
public class H48DAMASAGRRSGN implements Serializable {
	...
	public List<H48DAMASAGRRSGN> findByDate(@QueryParam("date") String date) {
		if (date == null)
		...
		final List<H48DAMASAGRRSGN> list = null;
		try {
