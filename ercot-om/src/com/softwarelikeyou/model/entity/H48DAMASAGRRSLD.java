...
@Entity
@Table(name="h48damasagrrsld")
@org.hibernate.annotations.Table(appliesTo="h48damasagrrsld", 
		indexes=@org.hibernate.annotations.Index(name="intervalDateIdx", columnNames={"intervalDate"}))
@XmlRootElement(name="H48DAMASAGRRSLD")
@Path("/H48DAMASAGRRSLD")
@XmlAccessorType(XmlAccessType.FIELD)
public class H48DAMASAGRRSLD implements Serializable {
	...
	public List<H48DAMASAGRRSLD> findByDate(@QueryParam("date") String date) {
		if (date == null)
		...
		final List<H48DAMASAGRRSLD> list = null;
		try {
