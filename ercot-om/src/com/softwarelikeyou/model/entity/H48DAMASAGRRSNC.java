...
@Entity
@Table(name="h48damasagrrsnc")
@org.hibernate.annotations.Table(appliesTo="h48damasagrrsnc", 
		indexes=@org.hibernate.annotations.Index(name="intervalDateIdx", columnNames={"intervalDate"}))
@XmlRootElement(name="H48DAMASAGRRSNC")
@Path("/H48DAMASAGRRSNC")
@XmlAccessorType(XmlAccessType.FIELD)
public class H48DAMASAGRRSNC implements Serializable {
	...
	public List<H48DAMASAGRRSNC> findByDate(@QueryParam("date") String date) {
		if (date == null)
		...
		final List<H48DAMASAGRRSNC> list = null;
		try {
