...
import com.softwarelikeyou.collector.weather.NDFD;
import com.softwarelikeyou.collector.weather.NDFD.Type;
...
public class ZipCodeTemperatureWorker implements Job {
	private static Logger logger = Logger.getLogger(ZipCodeTemperatureWorker.class);
	
	public ZipCodeTemperatureWorker() { }
